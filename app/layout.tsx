...
export const metadata: ExtendedMetadata = {
  ...
  title: "Surgical Instruments Suppliers | Surgical Instruments | Pacwest",
  description:
    "Pacwest is a trusted supplier of surgical instruments, providing high-quality, reliable tools for hospitals, clinics, and medical professionals.",
  verification: {
