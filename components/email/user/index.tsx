    ...
    return (
        <Container style={{ width: '90%', maxWidth: '800px', padding: '20px', fontFamily: 'Arial, sans-serif' }}>
            ...
            <Section style={{ padding: "48px 0", textAlign: "center" }}>
                <div style={{ fontSize: "24px", fontWeight: "bold", marginBottom: "8px" }}>Contact With Client</div>
                <Text style={{ fontSize: "14px", color: "#6b7280" }}>
                    Should you have any questions or require further assistance, with client.
                </Text>
